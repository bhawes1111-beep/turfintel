...
export function buildScheduleByEmployeeForDate(dateIso, weeklySchedules, scheduleOverrides) {
  ...
  for (const o of scheduleOverrides) {
    ...
    byEmp.set(o.employeeId, {
      ...
      lunchBreakMinutes: o.lunchBreakMinutes ?? prev?.lunchBreakMinutes ?? 30,
      lunchStartTime: o.lunchStartTime ?? null,
      lunchEndTime: o.lunchEndTime ?? null,
      autoLunchBreak: o.autoLunchBreak !== false,
      notes:       o.notes ?? null,
