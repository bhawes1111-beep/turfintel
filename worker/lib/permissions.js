// Permission matrix — the single source of truth (worker side).
//
// Roles map to a flat set of boolean permissions. Code checks PERMISSIONS,
// never raw role strings, so access rules live in exactly one place. The
// client mirror (src/utils/auth/permissions.js) is kept byte-identical in its
// ROLE_PERMISSIONS / PERMISSION_KEYS and a smoke test asserts they match.
//
