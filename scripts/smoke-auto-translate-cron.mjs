...
assert((highestMigration === '0050_crew_employee_translation_prefs.sql' || highestMigration === '0051_task_templates.sql'),
  `highest migration is 0050 or 0051 (task_templates accepted) (found: ${highestMigration})`)
