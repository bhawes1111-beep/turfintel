...
// Phase 9C.5b2 was provider-agnostic; later phases (9C.5c3) legitimately
// added the Workers AI binding. The 9C.5b2 authoring layer continues to
// work whether or not a provider is configured — manual *_es input
// always wins.
